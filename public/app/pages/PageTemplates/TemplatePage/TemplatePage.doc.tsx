...
// NOTE: A section won't render if the Markdown file imported here is empty. This is to make it easy to remove sections by just deleting
// the text instead of removing files and props.
export const TemplatePageProps: TFabricPlatformPageProps = {
  default: {
    ...
    propertiesTablesSources: [
      require('!raw-loader!office-ui-fabric-react/src/components/TeachingBubble/TeachingBubble.types.ts') as string,
    ],
  },
