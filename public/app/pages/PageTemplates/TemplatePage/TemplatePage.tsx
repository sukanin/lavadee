...
const TemplatePageBase: React.StatelessComponent<ITemplatePageProps> = props => {
  ...
  return (
    ...
    <Page
      ...
      // You can define custom sections using the `otherSections` prop. Here it is using a method that takes the platform as an argument
      // to return the correct array of section props.
